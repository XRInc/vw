        ...
        methodEventBind : function() {
            ...
            jet.extend(that,{
                ...
                nowBtn:function () {
                    ...
                    // 修改成只同步到日期，不同步时间  2021-12-01
                    newArr.hh = that.selectTime[0].hh;
                    newArr.mm = that.selectTime[0].mm;
                    newArr.ss = that.selectTime[0].ss;
                    //
                    that.selectDate = [newArr];
                ...
                sureBtn:function () {
                    ...
                    // 点击确认后日期不变  2021-12-01
                    var oldDateDay = [that.selectDate[0].YYYY + '-' + (that.selectDate[0].MM.toString().length > 1 ? that.selectDate[0].MM : '0' + that.selectDate[0].MM) + '-' + (that.selectDate[0].DD.toString().length > 1 ? that.selectDate[0].DD : '0' + that.selectDate[0].DD)];
                    that.selectValue = oldDateDay;
                    //
