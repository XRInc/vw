<?php
/**
 * new_products header_php.php
 */
if (!defined('NEW_PRODUCTS_PAGE_LIMIT')) define('NEW_PRODUCTS_PAGE_LIMIT', '30');
if (!defined('MOBILE_NEW_PRODUCTS_PAGE_LIMIT')) define('MOBILE_NEW_PRODUCTS_PAGE_LIMIT', '30');
...
if (true == $_isMobileTemplate) {
	$pageLimit = MOBILE_NEW_PRODUCTS_PAGE_LIMIT;
} else {
	$pageLimit = NEW_PRODUCTS_PAGE_LIMIT;
}
...
//Breadcrumb
$breadcrumb->add(__('New Arrivals'), 'root');
