        ...
        <div class="row">
            <?php foreach ($bestsellersList as $_product) { ?>
                <div class="col-xs-6 col-sm-4 col-md-3 products-grid">
                    <a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image boxs">
                       ...
                       <!-- <div class="text"><p class="details">QUICKVIEW</p></div>-->
                    </a>
